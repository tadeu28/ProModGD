...
namespace BPM2Game.Controllers
{
    ...
    public class ConfigurationController : Controller
    {
        ...
        {
            var designer = LoginUtils.Designer;
            var genres = DbFactory.GameGenreRepository.FindAllGenresByDesigner(designer.Id, false);
        ...
        public ActionResult ElementsAssociation()
        {
            try
            {
                ...
                var gameGenres = DbFactory.GameGenreRepository.FindAllGenresByDesigner(designer.Id, false);
